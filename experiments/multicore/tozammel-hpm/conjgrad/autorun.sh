...
echo ""
echo ""
echo "HighP5 and Pthread 128, 64, 32, 16, 8 way parallel codes will repeat for $high_repeat_count times"
echo "HighP5 and Pthread 4, 2, 1 way parallel codes will repeat for $low_repeat_count times"
echo ""
echo ""
...
./cg-highp5-high-script.sh $matrix_size $iterations $high_repeat_count
./cg-highp5-low-script.sh $matrix_size $iterations $low_repeat_count


echo "Going to run the Pthread program versions"
./cg-pthread-high-script.sh $matrix_size $iterations $high_repeat_count
./cg-pthread-low-script.sh $matrix_size $iterations $low_repeat_count
